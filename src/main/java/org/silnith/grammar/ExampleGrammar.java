...
public class ExampleGrammar extends Grammar<Terminals> {
    ...
    public static void main(final String[] args) {
        ...
        grammar.addProduction(new NonTerminal("S"), null, Terminals.A,
                Terminals.B, Terminals.C);
        
        final Parser<Terminals> parser = grammar.createParser(new NonTerminal(
                "S"), Terminals.EOF);
        
        final List<Terminals> input = Arrays.asList(Terminals.A, Terminals.B,
                Terminals.C, Terminals.EOF);
